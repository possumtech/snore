...
('write', 'full', 1, '["full","proposed","pass","warn","error","pattern"]', 0, 'result'),
('run', 'full', 1, '["full","proposed","pass","warn"]', 0, 'result'),
('env', 'full', 1, '["full","proposed","pass","warn"]', 0, 'result'),
('delete', 'full', 1, '["full","proposed","pass","warn","pattern"]', 0, 'result'),
('ask_user', 'full', 1, '["full","proposed","pass","warn"]', 0, 'result'),
('move', 'full', 1, '["full","proposed","pass","warn","pattern"]', 0, 'result'),
('copy', 'full', 1, '["full","proposed","pass","warn","pattern"]', 0, 'result'),
('read', 'full', 1, '["full","read","pattern"]', 0, 'result'),
