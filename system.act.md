...
* summary: One-liner summary of status # Full, detailed explanations can go in <known></known>
...
- [ ] edit: src/changingFile.txt # need to change file (no SEARCH/REPLACE means create file or replace all content)
