...
After the run, the DB is folded into the workspace and shipped
inside `submission.tar.gz` itself — anyone who downloads the
submission can replay the full reasoning trace.
